...
class Checkout extends MY_Controller
{
	...
	public function dana($input = null)
	{
		$this->checkout->table = 'cart';
		...
		$data['input']	= $input ? $input : (object) $this->checkout->getDefaultValues();
		$data['title']	= 'Checkout';
		$data['page']	= 'pages/checkout/dana';

		$this->view($data);
	}

	public function indomaret($input = null)
	{
		$this->checkout->table = 'cart';
		...
		$data['input']	= $input ? $input : (object) $this->checkout->getDefaultValues();
		$data['title']	= 'Checkout';
		$data['page']	= 'pages/checkout/indomaret';
	...
	public function createDana()
	{
		...
		if ($order = $this->checkout->create($data)) {
			...
			$data['title']		= 'Checkout Success';
			$data['content']	= (object) $data;
			$data['page']		= 'pages/checkout/successDana';
