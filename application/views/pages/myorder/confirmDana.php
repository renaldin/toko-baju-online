<!-- Halaman Konfirmasi Pembayaran Dana -->
    ...
    <div class="col-md-9">
      <div class="card">
        ...
        <div class="card-header bg-primary text-white">
          <strong>Konfirmasi Order #<?= $order->invoice; ?></strong>
        ...
        <!-- Button Konfirmasi Pembayaran Dana -->
