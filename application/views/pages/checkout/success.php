<!-- Halaman Konfirmasi Checkout Bank Transfer Berhasil -->
		...
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-header bg-primary text-white">
					<strong>Checkout Berhasil</strong> <a class="btn-sm bg-white border-white"><img src="<?= base_url('/images/gambar/bank.png') ?>" width="60" alt=""></a>
				</div>
				<!-- Catatan Checkout Bank Transfer Berhasil -->
				<div class="card-body">
					<h5>Nomer Order: <?= $content->invoice ?></h5>
					<p>Terima kasih, sudah berbelanja.</p>
					<p>Silakan lakukan pembayaran untuk bisa kami proses selanjutnya dengan cara:</p>
					<ol>
						<li>Lakukan pembayaran pada rekening <strong>BCA 3209123123</strong> a/n E-Joys</li>
