<!-- Halaman checkout bank transfer -->
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <!-- Form checkout bank transfer -->
                    <form action="<?= base_url("/checkout/create"); ?>" method="POST">
                        <div class="form-group">
                            <label for="">Metode Pembayaran Yang Dipilih</label>
                            <input type="text" class="form-control" name="metode_pembayaran" value="Bank Transfer" readonly />
        ...
        <div class="col-md-4">
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-3">
                        <!-- Judul Card Keranjang -->
                        <div class="card-header bg-primary text-white"><strong>Keranjang</strong></div>
                        <!-- Tabel Keranjang -->
                        <div class="card-body">
                            <table class="table">
                                <thead>
